...
/*****************************************************************************
  ...
  int16_t* in   - input signal

  int16_t* peak  - output (peak) envelope values
...
/*****************************************************************************
  ...
  int16_t* input - 16 bit values of signal

  int16_t* envelope - from rms or peak detector

  int16_t* output - 16 bit values estimated signal
...
void drc_process(int16_t* input, int16_t* envelope, int16_t* output, int len, cen_t* st) {
	...
	for (int i = 1; i < len; i++) {
		...
		output[i] = (int16_t)(st->out_dble[i]);
